  ...
  head: () => ({
    meta: [
      ...
      { title: "Pizza Solidária — Igreja Lagoinha Toledo" },
      {
        name: "description",
        content:
          "Compre uma pizza solidária e ajude a transformar vidas através das ações missionárias da Igreja Lagoinha Toledo.",
      },
      { name: "theme-color", content: "#0F1115" },
      { property: "og:title", content: "Pizza Solidária — Igreja Lagoinha Toledo" },
      {
        property: "og:description",
        content: "Uma pizza pode alimentar muito mais do que pessoas.",
      },
